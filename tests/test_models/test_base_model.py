#!/usr/bin/python3
""" defines the unittest for base model """
...
class test_basemodel(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        """ intializes basemodel test class  """
    ...
    def test_str(self):
        """ testing the string method of themodel"""
        i = self.value()
    ...
    def test_init(self):
        """Tests the initialization of basemodal
        """
    ...
    def test_default(self):
        """ default testing basemodel"""
        i = self.value()
        self.assertEqual(type(i), self.value)

    def test_kwargs(self):
        """ testing basemodel kwargs"""
        i = self.value()
        copy = i.to_dict()
        new = BaseModel(**copy)
    ...
    def test_kwargs_int(self):
        """ testing with kwargs with int kwargs"""
        i = self.value()
        copy = i.to_dict()
        copy.update({1: 2})
        with self.assertRaises(TypeError):
