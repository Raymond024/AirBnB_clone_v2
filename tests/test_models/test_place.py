...
def test_description(self):
        """tests place description attributes"""
        new = self.value()
    ...
    def test_number_rooms(self):
        """ tests place number of rooms attributes"""
        new = self.value()
    ...
    def test_number_bathrooms(self):
        """ tests place number of bathrooms attributes"""
        new = self.value()
    ...
    def test_max_guest(self):
        """ tests place max_guest attributes"""
        new = self.value()
    ...
    def test_price_by_night(self):
        """ tests place price by night attributes"""
        new = self.value()
    ...
    def test_latitude(self):
        """ tests place latitud attributes"""
        new = self.value()
    ...
    def test_longitude(self):
        """ tests place longitude attributes"""
        new = self.value()
        self.assertEqual(type(new.latitude), float if
                         os.getenv('HBNB_TYPE_STORAGE') != 'db' else
                         type(None))
    ...
    def test_user_id(self):
        """ tests place user_id attributes"""
        new = self.value()
